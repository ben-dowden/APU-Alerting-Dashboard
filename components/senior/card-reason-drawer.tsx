      ...
      <div className="grid gap-3 sm:grid-cols-[minmax(0,1fr)_minmax(280px,360px)]">
        <div className="flex flex-col gap-3">
          <div>
            ...
            {currentReason ? (
              <div className="mt-1">
                <p className="text-sm font-semibold text-neutral-950">{currentReason.categoryLabel}</p>
                <p className="text-xs font-medium text-neutral-600">{currentReason.detailLabel}</p>
              </div>
            ) : (
        ...
        >
          <label className="text-xs font-semibold uppercase tracking-normal text-neutral-500" htmlFor={`${tail}-reason-note`}>
            Note
          </label>
          <textarea
